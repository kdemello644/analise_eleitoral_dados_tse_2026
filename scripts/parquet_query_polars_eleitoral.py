...
TABLE_CANDIDATES: dict[str, list[str]] = {
    ...
    "contagem_colunas_resultado_partido_brasil": ["ouro/brasil/contagem_colunas_resultado_partido"],
    "contagem_colunas_resultado_partido_estado": ["ouro/estadual/contagem_colunas_resultado_partido"],
    "contagem_colunas_resultado_partido_municipio": ["ouro/municipal/contagem_colunas_resultado_partido"],
    ...
    "contagem_colunas_resultado_candidato_brasil": ["ouro/brasil/contagem_colunas_resultado_candidato"],
    "contagem_colunas_resultado_candidato_estado": ["ouro/estadual/contagem_colunas_resultado_candidato"],
    "contagem_colunas_resultado_candidato_municipio": ["ouro/municipal/contagem_colunas_resultado_candidato"],
...
TABLE_LABELS: dict[str, str] = {
    ...
    "contagem_colunas_resultado_partido_brasil": "Ouro - histogramas de resultado por partido Brasil",
    "contagem_colunas_resultado_partido_estado": "Ouro - histogramas de resultado por partido estado",
    "contagem_colunas_resultado_partido_municipio": "Ouro - histogramas de resultado por partido municipio",
    ...
    "contagem_colunas_resultado_candidato_brasil": "Ouro - histogramas de resultado por candidato Brasil",
    "contagem_colunas_resultado_candidato_estado": "Ouro - histogramas de resultado por candidato estado",
    "contagem_colunas_resultado_candidato_municipio": "Ouro - histogramas de resultado por candidato municipio",
